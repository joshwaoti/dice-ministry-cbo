...
import { CheckCircle2, ChevronLeft, FileText, Menu, PlayCircle, Save, X } from 'lucide-react';
          ...
          <div className="flex-1 flex flex-col p-6 max-w-4xl mx-auto w-full">
            <div className="mb-10">
              ...
              <div className="prose prose-invert mt-8 max-w-none">
                <p>Welcome to this lesson surface. It is designed to reflect the final student experience described in the PRD, with a focused teaching area, steady navigation, and private notes.</p>
                <p><strong>Key learning intent:</strong> move from passive watching to active reflection, scripture engagement, and practical application.</p>
              </div>
            </div>
